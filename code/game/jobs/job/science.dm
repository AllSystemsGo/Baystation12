...
/datum/job/scientist
	...
	alt_titles = list("Xenoarcheologist", "Anomalist", "Plasma Researcher", "Blue Space Researcher")
...
/datum/job/roboticist
	...
	selection_color = "#ffeeff"
	access = list(access_robotics, access_tox, access_tox_storage, access_tech_storage, access_morgue, access_research, access_xenoarch) //As a job that handles so many corpses, it makes sense for them to have morgue access.
